...
namespace ExRandom.MultiVariate.Tests {
    [TestClass()]
    public class HypercubeRandomTests {
        [TestMethod()]
        public void HypercubeRandomTest() {
            const int times = 10000;
            const decimal minX = -1.05m, maxX = 1.05m, minY = -1.05m, maxY = 1.05m;

            MT19937 mt = new();
            HypercubeRandom rd = new HypercubeRandom(mt, dim: 3);
            ...
            graph.Save(Workspace.OutDir + "plot_multi_hypercube_xy.png");
        }
    }
}