...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class ErlangRandomTests {
        [TestMethod()]
        public void ErlangRandomTest() {
            const int N = 1000000, X_MIN = -1, X_MAX = 16, X_SCALE = 10;

            MT19937 mt = new();
            Random rd = new ErlangRandom(mt, k: 3, theta: 2);
            ...
            pg.Save(Workspace.OutDir + "plot_con_erlang.png");
        }
    }
}