...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class ExponentialRandomTests {
        [TestMethod()]
        public void ExponentialRandomTest() {
            const int N = 1000000, X_MIN = -1, X_MAX = 5, X_SCALE = 10;

            MT19937 mt = new();
            Random rd = new ExponentialRandom(mt, lambda: 0.5);
            ...
            pg.Save(Workspace.OutDir + "plot_con_exponential.png");
        }
    }
}