...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class TriangularRandomTests {
        [TestMethod()]
        public void TriangularRandomTest() {
            const int N = 1000000, X_MIN = -3, X_MAX = 3, X_SCALE = 20;

            MT19937 mt = new();
            Random rd = new TriangularRandom(mt, min: -2, mode: 0.5, max: 1);
            ...
            pg.Save(Workspace.OutDir + "plot_con_triangular.png");
        }
    }
}