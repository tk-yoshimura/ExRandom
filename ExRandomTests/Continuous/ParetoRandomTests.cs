...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class ParetoRandomTests {
        [TestMethod()]
        public void ParetoRandomTest() {
            const int N = 1000000, X_MIN = 0, X_MAX = 5, X_SCALE = 50;

            MT19937 mt = new();
            Random rd = new ParetoRandom(mt, alpha: 3, beta: 1);
