...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class QGaussianRandomTests {
        [TestMethod()]
        public void QGaussianRandomTest() {
            const int N = 1000000, X_MIN = -4, X_MAX = 4, X_SCALE = 50;

            MT19937 mt = new();
            Random rd = new QGaussianRandom(mt, q: 0.5, beta: 1);
            ...
            pg.Save(Workspace.OutDir + "plot_con_qgaussian.png");
        }
    }
}