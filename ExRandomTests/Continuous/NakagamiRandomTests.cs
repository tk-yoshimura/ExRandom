...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class NakagamiRandomTests {
        [TestMethod()]
        public void NakagamiRandomTest() {
            const int N = 1000000, X_MIN = 0, X_MAX = 8, X_SCALE = 50;

            MT19937 mt = new();
            Random rd = new NakagamiRandom(mt, m: 1, omega: 3);
            ...
            pg.Save(Workspace.OutDir + "plot_con_nakagami.png");
        }
    }
}