...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class InverseChiSquaredRandomTests {
        [TestMethod()]
        public void InverseChiSquaredRandomTest() {
            const int N = 1000000, X_MIN = 0, X_MAX = 3, X_SCALE = 40;

            MT19937 mt = new();
            Random rd = new InverseChiSquaredRandom(mt, k: 3);
            ...
            pg.Save(Workspace.OutDir + "plot_con_inversechisquared.png");
        }
    }
}