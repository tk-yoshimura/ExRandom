...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class QExponentialRandomTests {
        [TestMethod()]
        public void QExponentialRandomTest() {
            const int N = 1000000, X_MIN = -1, X_MAX = 4, X_SCALE = 100;

            MT19937 mt = new();
            Random rd = new QExponentialRandom(mt, q: 1.5, lambda: 2);
            ...
            pg.Save(Workspace.OutDir + "plot_con_qexponential.png");
        }
    }
}