...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class CauchyRandomTests {
        [TestMethod()]
        public void CauchyRandomTest() {
            const int N = 1000000, X_MIN = -10, X_MAX = 10, X_SCALE = 10;

            MT19937 mt = new();
            Random rd = new CauchyRandom(mt, gamma: 1.5, mu: 2);
            ...
            pg.Save(Workspace.OutDir + "plot_con_cauchy.png");
        }
    }
}