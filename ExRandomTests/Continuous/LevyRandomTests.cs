...
namespace ExRandom.Continuous.Tests {
    [TestClass()]
    public class LevyRandomTests {
        [TestMethod()]
        public void LevyRandomTest() {
            const int N = 1000000, X_MIN = 0, X_MAX = 5, X_SCALE = 20;

            MT19937 mt = new();
            Random rd = new LevyRandom(mt, c: 2, mu: 0);
            ...
            pg.Save(Workspace.OutDir + "plot_con_levy.png");
        }
    }
}